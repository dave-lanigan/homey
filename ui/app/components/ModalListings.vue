...
<template>
  <Dialog :open="true" @update:open="open => !open && close()">
    <DialogScrollContent class="max-w-6xl w-[calc(100vw-2rem)] max-h-[90vh] p-0 gap-0">
      <DialogHeader class="sticky top-0 z-10 border-b border-border bg-background/95 p-6 backdrop-blur">
